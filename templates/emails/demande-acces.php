                ...
                <table width="520" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,76,76,0.06);">
                    ...
                    <tr>
                        <td style="padding: 32px;">
                            <h2 style="color: #333333; font-size: 18px; font-weight: 700; margin: 0 0 16px;">Demande d'acc&egrave;s &agrave; un module</h2>
                            <p style="color: #333333; font-size: 14px; line-height: 1.6; margin: 0 0 16px;">
                                Un utilisateur demande l'acc&egrave;s &agrave; un module de la plateforme :
                            </p>
                            <table width="100%" cellpadding="8" cellspacing="0" style="background: #f8f9fa; border-radius: 8px; margin: 0 0 16px;">
                                <tr>
                                    <td style="color: #666; font-size: 13px; font-weight: 600; width: 120px;">Utilisateur</td>
                                ...
                                <tr>
                                    <td style="color: #666; font-size: 13px; font-weight: 600;">Module</td>
                                    <td style="color: #333; font-size: 14px;">
                                        <strong><?= htmlspecialchars($moduleNom ?? '') ?></strong>
                                        <span style="color: #999; font-size: 12px;">(<?= htmlspecialchars($moduleSlug ?? '') ?>)</span>
                                    </td>
                                </tr>
                                <?php if (!empty($message)): ?>
                                <tr>
                                    <td style="color: #666; font-size: 13px; font-weight: 600;">Message</td>
                                    <td style="color: #333; font-size: 14px;"><?= nl2br(htmlspecialchars($message)) ?></td>
                                </tr>
                                <?php endif; ?>
                                <tr>
                                    <td style="color: #666; font-size: 13px; font-weight: 600;">Date</td>
                                    <td style="color: #333; font-size: 14px;"><?= htmlspecialchars($date ?? '') ?></td>
                                </tr>
                            </table>
                            <!-- CTA Button -->
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <a href="<?= htmlspecialchars($lienAcces ?? '') ?>"
