                ...
                <table width="520" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,76,76,0.06);">
                    ...
                    <tr>
                        <td style="padding: 32px;">
                            <h2 style="color: #333333; font-size: 18px; font-weight: 700; margin: 0 0 16px;">Réinitialisation de votre mot de passe</h2>
                            ...
                            <p style="color: #999; font-size: 12px; line-height: 1.6; margin: 24px 0 0;">
                                Ce lien expire dans <?= (int) ($expiration ?? 1) ?> heure(s). Si vous n'avez pas fait cette demande, ignorez cet email.
                            </p>
                        </td>
                    </tr>
